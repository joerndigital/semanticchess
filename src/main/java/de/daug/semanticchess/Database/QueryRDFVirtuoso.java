...
public class QueryRDFVirtuoso {
	...
	public static void main(String[] args) {
		QueryRDFVirtuoso virtQuery = new QueryRDFVirtuoso();
		String json = virtQuery.getRDFResult(
