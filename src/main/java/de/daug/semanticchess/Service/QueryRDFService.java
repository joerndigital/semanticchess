...
import de.daug.semanticchess.Database.QueryRDFVirtuoso;
 ...
 */
@Service
public class QueryRDFService{
	
	@Autowired
	private QueryRDFVirtuoso virtuosoRDFQuery;
	
	/**
	 * Takes the user query and returns a XML
	...
	public String getRDFResult(String strQuery){
		...
		return virtuosoRDFQuery.getRDFResult(strQuery);
