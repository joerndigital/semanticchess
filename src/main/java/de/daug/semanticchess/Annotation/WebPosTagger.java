 ...
 */
public class WebPosTagger {

	// attributes
	private String query = "";
	private String taggedQuery = "";
	private StanfordCoreNLPClient pipeline = null;
	 ...
	 */
	public Annotation setAnnotator(StanfordCoreNLPClient pipeline, String query) {
	 ...
	 */
	public StanfordCoreNLPClient getPipeline() {
	...
	public static void main(String[] args) {
		...
		// ========
		// Constructor
		WebPosTagger tagger = new WebPosTagger();
		// initialize pipeline to use it more often, does not have to load again
		// for a new query
		StanfordCoreNLPClient pipeline = tagger.getPipeline();
